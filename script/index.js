...
function send(text) {
	...
	$.ajax({
    	...
    	data: JSON.stringify({ "userMessage": text }),
		success: function(resp) {
            console.log(resp.message);
		
			newRecievedMessage(JSON.stringify(resp.message));
...
function createNewMessage(message) {
	...
	$chatlogs.append(
		$('<div/>', {'class': 'chat friend'}).append(
			$('<div/>', {'class': 'user-photo'}).append($('<img src="images/robot.png" />')), 
